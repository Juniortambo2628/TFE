    ...
    return (
        <AdminLayout title="Payments Management">
            ...
            <SummaryTiles
                className="mb-4"
                items={[
                    { label: 'Total Volume', value: formatMoney(stats.total_volume), icon: 'fa-money-bill-wave', accent: 'blue' },
                    { label: 'Completed', value: stats.completed_count || 0, icon: 'fa-check-circle', accent: 'teal' },
