        ...
        <AdminLayout title="Advanced Analytics">
            ...
            <SummaryTiles
                ...
                items={[
                    ...
                    { label: 'Market Potential Avg', value: formatMoney(stats.avg_calc_cost), icon: 'fa-search-dollar', accent: 'cyan' },
                    { label: 'Itineraries Saved', value: stats.total_saved, icon: 'fa-save', accent: 'teal' },
                    { label: 'Actual Conversion Avg', value: formatMoney(stats.avg_itinerary_cost), icon: 'fa-chart-line', accent: 'graph' },
