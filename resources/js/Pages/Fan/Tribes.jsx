...
export default function Tribes({ auth, tribes, stats }) {
    ...
    const [newTribeData, setNewTribeData] = useState({ name: '', description: '', privacy: 'public' });
    ...
    return (
        <FanLayout title="Tribes">
            ...
            <div className="content-card mt-4">
                ...
                <p className="text-white-50 px-3 mb-3">Discover and join tribes that match your interests</p>
