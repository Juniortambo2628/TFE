    ...
    */
    ...
    'tournaments' => [
        ...
        'ucl_2025_26' => [
            ...
            'hosts' => ['Europe'],
            'host_flag_codes' => ['eu'],
            'team_flag_codes' => ['es', 'de', 'fr', 'gb', 'it', 'pt', 'nl', 'be', 'hr', 'at', 'ch', 'dk', 'pl', 'cz', 'rs', 'ua', 'sk', 'si', 'al', 'ro', 'hu', 'tr', 'ge'],
        ...
        'copa_2024' => [
            ...
            'hosts' => ['United States'],
            'host_flag_codes' => ['us'],
            'team_flag_codes' => ['ar', 'bo', 'br', 'cl', 'co', 'cr', 'ec', 'jm', 'mx', 'pa', 'py', 'pe', 'us', 'uy', 've', 'ca'],
        ...
        'afcon_2023' => [
            ...
            'hosts' => ["Côte d'Ivoire"],
            'host_flag_codes' => ['ci'],
            'team_flag_codes' => ['dz', 'bf', 'cm', 'cv', 'cf', 'cg', 'eg', 'ga', 'gh', 'gn', 'gw', 'ci', 'mg', 'ml', 'mr', 'ma', 'mz', 'na', 'ng', 'sn', 'za', 'tz', 'tn', 'ug'],
        ...
        'wc_2022' => [
            ...
            'hosts' => ['Qatar'],
            'host_flag_codes' => ['qa'],
            'team_flag_codes' => ['qa', 'ec', 'sn', 'nl', 'gb', 'ir', 'us', 'gb', 'ar', 'sa', 'mx', 'pl', 'fr', 'au', 'dk', 'tn', 'es', 'cr', 'de', 'jp', 'be', 'ca', 'ma', 'hr', 'br', 'rs', 'ch', 'cm', 'pt', 'gh', 'uy', 'kr'],
