    ...
    'tournaments' => [
        ...
        'wc_2026' => [
            ...
            'pricing' => [
                ...
                'venue_tiers' => [
                    'New York New Jersey Stadium' => ['tier' => 'High', 'multiplier' => 1.5, 'hotel_3star' => 250],
                    'Los Angeles Stadium' => ['tier' => 'High', 'multiplier' => 1.45, 'hotel_3star' => 240],
                    'San Francisco Bay Area Stadium' => ['tier' => 'High', 'multiplier' => 1.45, 'hotel_3star' => 240],
                    'Miami Stadium' => ['tier' => 'High', 'multiplier' => 1.4, 'hotel_3star' => 220],
                    'Boston Stadium' => ['tier' => 'High', 'multiplier' => 1.35, 'hotel_3star' => 210],
                    'Seattle Stadium' => ['tier' => 'Standard', 'multiplier' => 1.1, 'hotel_3star' => 180],
                    'Philadelphia Stadium' => ['tier' => 'Standard', 'multiplier' => 1.1, 'hotel_3star' => 180],
                    'Dallas Stadium' => ['tier' => 'Standard', 'multiplier' => 1.0, 'hotel_3star' => 160],
                    'Houston Stadium' => ['tier' => 'Standard', 'multiplier' => 1.0, 'hotel_3star' => 160],
                    'Atlanta Stadium' => ['tier' => 'Standard', 'multiplier' => 1.0, 'hotel_3star' => 160],
                    'Toronto Stadium' => ['tier' => 'Standard', 'multiplier' => 1.1, 'hotel_3star' => 180],
                    'BC Place Vancouver' => ['tier' => 'Standard', 'multiplier' => 1.15, 'hotel_3star' => 190],
                    'Kansas City Stadium' => ['tier' => 'Standard', 'multiplier' => 0.95, 'hotel_3star' => 150],
                    'Mexico City Stadium' => ['tier' => 'Low', 'multiplier' => 0.7, 'hotel_3star' => 100],
                    'Estadio Guadalajara' => ['tier' => 'Low', 'multiplier' => 0.6, 'hotel_3star' => 85],
                    'Estadio Monterrey' => ['tier' => 'Low', 'multiplier' => 0.65, 'hotel_3star' => 90],
                ],
                'flight_origins' => [
        ...
        'euro_2024' => [
            ...
            'pricing' => [
                ...
                'venue_tiers' => [
                    'Munich' => ['tier' => 'High', 'multiplier' => 1.3, 'hotel_3star' => 170],
                    'Berlin' => ['tier' => 'High', 'multiplier' => 1.25, 'hotel_3star' => 160],
                    'Dortmund' => ['tier' => 'Standard', 'multiplier' => 1.0, 'hotel_3star' => 130],
                    'Gelsenkirchen' => ['tier' => 'Low', 'multiplier' => 0.9, 'hotel_3star' => 110],
                    'Stuttgart' => ['tier' => 'Standard', 'multiplier' => 1.1, 'hotel_3star' => 140],
                    'Hamburg' => ['tier' => 'Standard', 'multiplier' => 1.15, 'hotel_3star' => 145],
                    'Leipzig' => ['tier' => 'Low', 'multiplier' => 0.85, 'hotel_3star' => 105],
                    'Frankfurt' => ['tier' => 'Standard', 'multiplier' => 1.2, 'hotel_3star' => 155],
                    'Cologne' => ['tier' => 'Standard', 'multiplier' => 1.05, 'hotel_3star' => 135],
                    'Gelsenkirchen' => ['tier' => 'Low', 'multiplier' => 0.9, 'hotel_3star' => 110],
                ],
                'flight_origins' => [
        ...
        'afcon_2027' => [
            ...
            'pricing' => [
                ...
                'venue_tiers' => [
                    'Nairobi' => ['tier' => 'High', 'multiplier' => 1.2, 'hotel_3star' => 90],
                    'Dar es Salaam' => ['tier' => 'Standard', 'multiplier' => 1.0, 'hotel_3star' => 75],
                    'Kampala' => ['tier' => 'Low', 'multiplier' => 0.8, 'hotel_3star' => 55],
                    'Mombasa' => ['tier' => 'Standard', 'multiplier' => 0.95, 'hotel_3star' => 70],
                    'Arusha' => ['tier' => 'Low', 'multiplier' => 0.85, 'hotel_3star' => 60],
                ],
                'flight_origins' => [
